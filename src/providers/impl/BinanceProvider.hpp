...
class BinanceProvider : public ICryptoProvider, public BaseProvider {
public:
    BinanceProvider(std::shared_ptr<IHttpClient> client,
    ...
    std::optional<OrderBook> GetOrderBook(const std::string& ticker, const int depth) override;
